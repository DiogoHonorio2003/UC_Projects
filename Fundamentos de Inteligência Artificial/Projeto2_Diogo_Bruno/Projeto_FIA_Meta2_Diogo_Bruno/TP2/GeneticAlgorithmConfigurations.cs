...
public static class GeneticAlgorithmConfigurations
{
    ...
    */
    ...
    public static int num_torneio = 5;
    ...
    public static Mutation mutationOperator = new Mutation(mutationProbability);
    public static ParentSelection parentSelection = new ParentSelection(num_torneio);
